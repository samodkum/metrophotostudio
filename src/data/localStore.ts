...
// -- Categories -- 
// -- Categories (Moved to Supabase) -- 
// -- Gallery (Moved to Supabase) --
...
export const getStats = () => {
    return {
        gallery: 0, // Now fetched from supabase in dashboard
        categories: 0, // Now fetched from supabase in dashboard
